...
def load_deepseek(model_name, device, quantization=None):
...
def load_model(model_name, device, quantization=None):
    if "llama" in model_name:
        return load_llama(model_name, device, quantization)
    elif "deepseek" in model_name:
        return load_deepseek(model_name, device, quantization)
    else:
